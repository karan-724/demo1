...
//     const [paymentlinkdata, setPaymentlinkdata] = useState({ upi_link: "", qr_code: '', transaction_id: "" });
...
//         return `TXN${random}`;
//     }
//     const paymentlinkganrat = async (e) => {
//         let headersList = {
//             "Accept": "*/*",
//             "User-Agent": "Thunder Client (https://www.thunderclient.com)",
//             "token": e,
...
//         let response = await fetch("https://finziopay.com/api/payment/initiate", {
//             method: "POST",
//             body: bodyContent,
//             headers: headersList
//         });
...
//             "data": {
//                 "order_id": "TXN123456",
//                 "transaction_id": "PAY1746440942",
//                 "payment_link": "https://finziopay.com/api/checkout/PAY1746440942",
//                 "upi_link": "upi://pay?pa=....@.....==",
//                 "qr_code": "data:image/svg+xml;base64,PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iVVRGLTg...........=="
//             }
//         }
...
//                 const res = await axios.get(`https://finziopay.com/api/checkout/status/${paymentlinkdata.transaction_id}`);
